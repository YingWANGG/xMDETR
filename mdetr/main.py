...
from dataset.clevrref import ClevrRefEvaluator
from dataset.coco_eval import CocoEvaluator
from dataset.flickr_eval import FlickrEvaluator
from dataset.phrasecut_eval import PhrasecutEvaluator
from dataset.refexp import RefExpEvaluator
...
def get_args_parser():
    ...
    parser.add_argument("--test_gqa_ann_path", type=str, default="xgqa_ann")
    ...
    #choices=("roberta-base", "distilroberta-base", "roberta-large", "uklfr/gottbert-base", "bert-base-chinese"),
